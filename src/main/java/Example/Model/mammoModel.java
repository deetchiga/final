...
public class mammoModel {
    ...
    public void setNOC(Number NOC){
        this.NOC=NOC;
    }
    public Number getNOPREG(){
        return NOPREG;
    }
    public void setNOPREG(Number NOPREG){
        this.NOPREG=NOPREG;
    }
    public Number getAgeFP(){
        return AgeFP;
    }
    public void setAgeFP(Number AgeFP){
        this.AgeFP=AgeFP;
    }
    public Boolean getAYPreg(){
        return AYPreg;
    }
    public void setAYPreg(Boolean AYPreg){
        this.AYPreg=AYPreg;
    }
    public Date getLPeriodDate(){
        return LPeriodDate;
    }
    public void setLPeriodDate(Date LPeriodDate){
        this.LPeriodDate=LPeriodDate;
    }
    ...
    public Number getBirthCtrlD(){
        return AgeFP;
    }
    public void setBirthCtrlD(Number BirthCtrlD){
        this.BirthCtrlD=BirthCtrlD;
    }
    public Boolean getHRep(){
        return HRep;
    }
    public void setHRep(Boolean HRep){
        this.HRep=HRep;
    }
    ...
    public Boolean getBSRad(){
        return BS;
    }
    public void setBSRad(Boolean BSRad){
        this.BSRad=BSRad;
    }
    public Date getBSRadDate(){
        return BSRadDate;
    }
    public void setBSRadDate(Date BSRadDate){
        this.BSRadDate=BSRadDate;
    }
    public String getBrsRad(){
        return BrsRad;
    }
    public void setBrsRad(String BrsRad){
        this.BrsRad=BrsRad;
    }
    ...
    public String getChemoS(){
        return ChemoS;
    }
    public void setChemoS(String ChemoS){
        this.ChemoS=ChemoS;
    }
    ...
    public String getBSComplaint(){
        return BSComplaint;
    }
    public void setBSComplaint(String BSComplaint){
        this.BSComplaint=BSComplaint;
    }
    public Boolean getSkinDimp(){
        return SkinDimp;
    }
    public void setSkinDimp(Boolean SkinDimop){
        this.SkinDimp=SkinDimp;
    }
    ...
    public String getCDischarge(){
        return CDischarge;
    }
    public void setCDischarge(String CDischarge){
    ...
    public String getHisBC(){
        return HisBC;
    }
    public void setHisBC(String HisBC){
        this.HisBC=HisBC;
    }
